...
class Loteria extends Component {
  ...
  _compraBoletos = async (_numBoletos) => {
    try {
      ...
      Swal.fire({
        ...
        width: 800,
        padding: "3em",
        text: `Has comprado ${_numBoletos} boletos, ¡mucha suerte!`,
        backdrop: `
            rgba(15, 238, 168, 0.2)
            left top
            no-repeat`,
  ...
  _precioBoleto = async () => {
    try {
      console.log("Precio de boleto en ejecución...");
      ...
      Swal.fire({
        ...
        width: 800,
        padding: "3em",
        text: `El precio del boleto es de ${_precio} tokens`,
        backdrop: `
            rgba(15, 238, 168, 0.2)
            left top
            no-repeat`,
  ...
  _tusBoletos = async () => {
    try {
      ...
      const _boletos = await this.state.contract.methods
        .tusBoletos(this.state.account)
        .call();
      Swal.fire({
        icon: "info",
        title: `Tienes ${_boletos} boletos.`,
        width: 800,
        padding: "3em",
        backdrop: `
            rgba(15, 238, 168, 0.2)
