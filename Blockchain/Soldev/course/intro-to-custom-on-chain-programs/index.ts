...
// Address of the program we are calling
const PING_PROGRAM_ADDRESS = new web3.PublicKey(
  "ChT1B39WKLS8qUrkLvFDXMhEJ4F1XZzwUNHUt4AU9aVa"
);

// Address of the program that stores the data
...
// Load the Keypair of my address
...
// Initialize the PublicKey for the program account
const programId = new web3.PublicKey(PING_PROGRAM_ADDRESS);

// Initialize the PublicKey for the data account
...
// Finally, let's log the result of that function call so we can look it up on the Solana Explorer.
